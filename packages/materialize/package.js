...
Package.describe({
  name: 'girlcode:materialize',  // http://atmospherejs.com/materialize/materialize
  summary: 'Fork from Materialize (official): A modern responsive front-end framework based on Material Design',
  version: '0.97.8',
